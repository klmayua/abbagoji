...
export function SentimentDot({ sentiment, className = '' }: { sentiment: SentimentType; className?: string }) {
  const dotColors = {
  ...
  return (
    <span
      className={`inline-block w-2.5 h-2.5 rounded-full ${dotColors[sentiment]} ${className}`}
